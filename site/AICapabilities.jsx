...
function AICapabilities() {
  ...
  return (
    <section id="ai-systems" className="fullbleed" style={{ paddingTop: 96, paddingBottom: 96 }}>
      <div className="fullbleed-inner">
        <div style={{
          ...
          {/* Left: heading block — sticky on desktop so it anchors while list scrolls */}
          <Reveal variant="fade">
            <div style={{ position: mobile ? 'static' : 'sticky', top: 24 }}>
              <h2 style={{
              ...
              <p style={{
                ...
                Beyond websites and campaigns — AI workflows that turn messy work into
                repeatable process.
              </p>
            </div>
          </Reveal>
          ...
          <div>
            {AI_CAPABILITIES.map((c, i) => (
              <Reveal key={c.title} delay={Math.min(i, 5) * 55}>
                <div style={{
                  display: 'flex',
                  gap: 16,
                  padding: '20px 0',
                  ...
                  <span style={{ flexShrink: 0, marginTop: 3 }}>
                    <Icon name={c.icon} size={16} color="var(--accent)" />
                  </span>
...
Object.assign(window, { AICapabilities });
